            ...
            <form onSubmit={submitProduct} id='PRODUCT_FORM'>
                ...
                <div className="mb-6 flex space-x-5">
                    <div className='w-full'>
                        ...
                        <input type='number' onChange={handleInput} value={productInput.original_price} name="original_price" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                    ...
                    <div className='w-full'>
                        ...
                        <input type='number' onChange={handleInput} value={productInput.selling_price} name="selling_price" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                    ...
                    <div className='w-full'>
                        ...
                        <input type='number' onChange={handleInput} value={productInput.quantity} name="quantity" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                    ...
                    <div className="w-full">
                      ...
                      <input type='number' onChange={handleInput} value={productInput.warranty} name="warranty" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
